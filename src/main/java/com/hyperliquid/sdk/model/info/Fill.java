package com.hyperliquid.sdk.model.info;
 ...
 * 用户成交实体封装。
 *
 * <p>说明：官方返回字段在不同接口与版本可能存在差异，因此除常用字段外，
 * 其余未知/附加字段将通过 {@link #extra} 动态接收，确保反序列化不失败，
 * 同时为 SDK 使用者保留完整信息。</p>
 */
...
public class Fill {
    ...
    public static class Builder {
        ...
        public Builder time(Long t) { f.time = t; return this; }
        public Builder coin(Integer c) { f.coin = c; return this; }
        public Builder isBuy(Boolean b) { f.isBuy = b; return this; }
        public Builder size(Double s) { f.size = s; return this; }
        public Builder price(Double p) { f.price = p; return this; }
        public Builder putExtra(String k, Object v) { f.extensions.put(k, v); return this; }
        public Fill build() { return f; }
    }
    ...
    /** 设置是否买入 */
    public void setIsBuy(Boolean buy) { isBuy = buy; }
