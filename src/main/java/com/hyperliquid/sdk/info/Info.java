...
import com.hyperliquid.sdk.api.API;
...
public class Info extends API {
     ...
     * @return Candle 列表
     */
    public java.util.List<com.hyperliquid.sdk.model.info.Candle> candlesSnapshotTyped(int coin, long intervalMs,
            long startMs, long endMs) {
        com.fasterxml.jackson.databind.JsonNode node = candlesSnapshot(coin, intervalMs, startMs, endMs);
        return com.hyperliquid.sdk.parser.CandleParser.parseList(node);
    }
     ...
     * @return Candle 列表
     */
    public java.util.List<com.hyperliquid.sdk.model.info.Candle> candleSnapshotTyped(int coin, String interval,
            long startTime, long endTime) {
        com.fasterxml.jackson.databind.JsonNode node = candleSnapshot(coin, interval, startTime, endTime);
        return com.hyperliquid.sdk.parser.CandleParser.parseList(node);
    }
     ...
     * @return Candle 列表
     */
    public java.util.List<com.hyperliquid.sdk.model.info.Candle> candleSnapshotTyped(String coinName, String interval,
            long startTime, long endTime) {
        ...
        payload.put("type", "candleSnapshot");
        payload.put("req", req);
        com.fasterxml.jackson.databind.JsonNode node = post("/info", payload);
        return com.hyperliquid.sdk.parser.CandleParser.parseList(node);
    }
     ...
     */
    public java.util.Optional<com.hyperliquid.sdk.model.info.Candle> candleSnapshotLatestTyped(int coin,
            String interval) {
        long endTime = System.currentTimeMillis();
        long intervalMs = intervalToMs(interval);
        long startTime = endTime - intervalMs;
        com.fasterxml.jackson.databind.JsonNode node = candleSnapshot(coin, interval, startTime, endTime);
        return com.hyperliquid.sdk.parser.CandleParser.parseLatest(node);
    }
     ...
     * @throws com.hyperliquid.sdk.utils.Error 若间隔不受支持
     */
    private long intervalToMs(String interval) {
        if (interval == null)
            throw new com.hyperliquid.sdk.utils.Error("间隔字符串不能为空");
        switch (interval) {
            case "1m":
                return 60_000L;
            case "3m":
            ...
            default:
                throw new com.hyperliquid.sdk.utils.Error("不支持的间隔字符串：" + interval);
        }
    }
     ...
     * @return 订单列表（类型安全）
     */
    public List<com.hyperliquid.sdk.model.info.OpenOrder> openOrdersTyped(String address) {
        JsonNode node = openOrders(address);
        return mapper.convertValue(node,
                TypeFactory.defaultInstance().constructCollectionType(List.class,
                        com.hyperliquid.sdk.model.info.OpenOrder.class));
    }
     ...
     * @return 订单列表（类型安全）
     */
    public List<com.hyperliquid.sdk.model.info.OpenOrder> openOrdersTyped(String address, String dex) {
     ...
     */
    public com.hyperliquid.sdk.model.info.PerpDexStatus perpDexStatusTyped(String dex) {
        JsonNode node = perpDexStatus(dex);
        return mapper.convertValue(node, com.hyperliquid.sdk.model.info.PerpDexStatus.class);
    }
